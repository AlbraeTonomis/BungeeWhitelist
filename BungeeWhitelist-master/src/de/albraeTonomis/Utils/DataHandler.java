package de.albraeTonomis.Utils;
...
import de.albraeTonomis.BungeeEssentials;
...
public class DataHandler {
    ...
    public static void loadFiles() {
        ...
        try {
            ...
            configuration.set("whitelist.global.removed", blanklist);
            for (String server : BungeeEssentials.getInstance().getProxy().getServers().keySet()) {
                ...
                configuration.set("whitelist." + server + ".removed", blanklist);
            }
    ...
    public static void saveEssentials(java.util.Map<String, Boolean> enabled, java.util.Map<String, java.util.List<String>> whitelisted,java.util.Map<String, java.util.List<String>> removed) {
        ...
        whitelistconfig.set("whitelist.global.whitelisted", removed.get("global"));
        ...
        for (String server : removed.keySet()) whitelistconfig.set("whitelist." + server + ".removed", removed.get(server));
        try {
